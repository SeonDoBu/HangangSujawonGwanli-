...
<table class="table" style="margin-top: 30px; width: 900px;">
  ...
  <tbody class="table-group-divider">
   ...
   <tr>
   	...
   	<td><a href=""  onclick="showpopDetail()" id="chk1" data-value="${sul.sluice_id }" > ${sul.name}</a></td>
   	<td>${sul.sluice_id }</td>
   	<td>${sul.mapy }</td>
   	<td>${sul.mapx }</td>
   		<td>
   	...
   	<td>운영기관 조인 ㄱ</td>
       <td><a href="ObservDataList"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
