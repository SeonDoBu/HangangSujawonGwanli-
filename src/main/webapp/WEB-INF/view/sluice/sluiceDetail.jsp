		...
		<div class="container"
			...
			<div class="container">
				<div>
					...
					<p>
						관측소명:<input style="margin-left: 10px;" name="name"
							value="${sluice.name }" type="text">
					</p>
					<div>

						표준 코드: <input type="text" name="sluice_id"
							value="${sluice.sluice_id }">
					</div>
					<div>
						<p>
							위도: <input style="margin-left: 38px;" type="number"
								step="0.000000001" name="mapy" value="${sluice.mapy }">
						</p>
						<p>
							경도:<input style="margin-left: 42px;" type="number"
								step="0.000000001" name="mapx" value="${sluice.mapx }">
						</p>
					</div>
					<div>
						<p>
						...
						하천 세부 주소: <input type="text" name="address"
							value="${sluice.address }">

					</div>
					<div style="margin-left: 100px; margin-top: 40px;">

						<button type="submit"
							style="width: 80px; margin-right: 40px; height: 30px; background-color: #000042; color: white;"
