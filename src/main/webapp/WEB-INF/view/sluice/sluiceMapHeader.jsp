...
<ul class="nav nav-underline" style="background-color: #000042; height: 80px; " >
  ...
  <li class="nav-item" style="margin-left: 10px;">
    <a class="nav-link" href="sluiceMain" style="color: #FFFFFF;"> 지도 </a>
  </li>
...
<div class="dropdown">
  ...
  <ul class="dropdown-menu">
    ...
    <li class="nav-item">
    <a class="nav-link " href="sujawonList.do" style="color: #FFFFFF;">수자원</a>
  </li>
...
<li style="margin-left: 100px;">
  ...
  <li class="nav-item">
          <a class="nav-link" href="#" style="color: #FFFFFF; ">사이트맵 |</a>
        </li>

   <li class="nav-item">
          <a class="nav-link" href="#" style="color: #FFFFFF; ">{user_name}님 |</a>
        </li>

  <li class="nav-item">
          <a class="nav-link" href="#" style="color: #FFFFFF; ">로그아웃</a>
        </li>
